...
@section('content')
    <style>
      ...
      <form action="{{ route('page.update', ['page' => $page->id]) }}" enctype="multipart/form-data" method="POST">
        @csrf
        {{ method_field('PATCH') }}
        <div class="row">
                    ...
                    <div style="width: 100%;" class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb20">
                                <div class="form-group">
                                    ...
                                    <input value="{{ $page->name }}" onkeyup="return convert(this)" name="name" id="name" class="form-control" placeholder="Nhập tên trang">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb20">
                                ...
                                <textarea class="p-2" name="contents" id="content" cols="133" rows="10">{{ $page->contents }}</textarea>
