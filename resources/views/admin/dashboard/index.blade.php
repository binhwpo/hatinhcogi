                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="icon1 bg-success-transparent my-auto  float-right"> <i class="feather feather-users"></i> </div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="icon1 bg-primary-transparent my-auto  float-right"> <i class="feather feather-box"></i> </div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="icon1 bg-secondary-transparent brround my-auto  float-right"> <i class="feather feather-dollar-sign"></i> </div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <li class="item">
                    <div class="card p-4 ">
                        <div class="d-flex">
                            ...
                            <span class="icon icon-shape bg-primary float-right ml-auto bradius  mb-0 mr-3 my-auto"> <i class="feather feather-mail text-white"></i> </span>
                        </div>
                    </div>
                </li>
                <li class="item">
